...
export default function Navbar() {
    ...
    <a class="flex title-font font-medium items-center text-black mb-4 md:mb-0" href="/home">
      ...
      <a class=" font-bold py-2 px-4 hover:text-blue-500" href="/nft">NFT</a>
      <a class=" font-bold py-2 px-4 hover:text-blue-500" href="/mint">MINT</a>
      
      <a class=" font-bold py-2 px-4 hover:text-blue-500" href="/gallery">COLLECTION</a>
      ...
      <a class=" font-bold py-2 px-4 hover:text-blue-500" href="/gallery">FAUCET</a>
      <ConnectWallet 
        accentColor="#fff"
        colorMode="dark"
